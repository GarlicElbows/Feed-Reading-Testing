...
$(
  (function () {
    ...
    describe("RSS Feeds", function () {
      ...
      it("URL is defined also not empty", function () {
      ...
      it("name created also not empty", function () {
    ...
    describe("The menu", function () {
      it("hidden menu", function () {
        expect($("body").is(":visible")).toBe(true);
      });
    ...
    describe("New Feed Selection", function () {
      ...
      it("is different from old", function () {
        expect($(".feed").html()).not.toBe(testerFeed);
      });
    });
  })()
);
